#!/usr/bin/python3
"""
A module to access to GitHub API and uses the info
"""
import requests
...
def main(argv):
    """
    A funct that list 10 commits (from the most recent to oldest)
    of the repo.The 1st arg will be the repo name
    and the 2nd arg will be the owner name
    """
